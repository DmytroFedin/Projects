...
alert(prompt(`Введите трехзначное число:`).split``.filter((e, i, a) => a.join``.indexOf(e) !== a.join``.lastIndexOf(e)).join``.trim() === `` ? `Совпадений не найдено` : `Найдено совпадение цифр`);
