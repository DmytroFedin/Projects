  ...
  func = {
    ...
    task8: () => {
      let showHours = +prompt('Сколько часов ');
      let showMinutes = +prompt('Сколько минут');
      let showSeconds = +prompt('Сколько секунд');
      let newSeconds = 0;

      return newSeconds = ((showHours * 3600) + (showMinutes * 60) + showSeconds);
    },
    task9: () => {
      toSec(+toSeconds);
    },
