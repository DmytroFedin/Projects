...
const execute = (e) => {
  ...
  for (let i = 1; i <= quantity; i++) {
    ...
    compareNumb1 = document.getElementById('js-input' + i + '-1').value;
    compareNumb2 = document.getElementById('js-input' + i + '-2').value;
    item.addEventListener('click', () => {
      ...
      showHours = document.getElementById('js-input7-1').value;
      showMinutes = document.getElementById('js-input7-2').value;
      showSeconds = document.getElementById('js-input7-3').value;
      hoursToSec = document.getElementById('js-input8-1').value;
      minutesToSec = document.getElementById('js-input8-2').value;
      secondsToSec = document.getElementById('js-input8-3').value;
      fromSeconds = document.getElementById('js-input9-1').value;
      compareHour1 = document.getElementById('js-input10-1').value;
      compareMinute1 = document.getElementById('js-input10-2').value;
      compareSeconds1 = document.getElementById('js-input10-3').value;
      compareHour2 = document.getElementById('js-input10-4').value;
      compareMinute2 = document.getElementById('js-input10-5').value;
      compareSeconds2 = document.getElementById('js-input10-6').value;
      func['task' + i]();
    })
  }
  }
