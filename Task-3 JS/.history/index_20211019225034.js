  ...
  func = {
    ...
    task4: () => {
      ...
      if (calcNumberOne === 0 || calcNumberOne === null && calcNumberTwo === 0 || calcNumberTwo === null) {
        let i = calcNumberOne;
        calcNumberOne = calcNumberTwo;
        calcNumberTwo = i;
        sqr = calcNumberOne*calcNumberOne
      }
      else if (isFinite(calcNumberOne, calcNumberTwo)){
        sqr = calcNumberOne*calcNumberTwo
      }
      console.log(sqr);
    },
    task5: () => {
