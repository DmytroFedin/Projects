...
let checkNumber = +prompt('Вставьте трехзначное число','')
let checkNumber1 = +(checkNumber / 100);//5.55
let checkNumber2 = +(checkNumber / 10) % 10;//5.55
let checkNumber3 = +checkNumber % 10;//
if(checkNumber1===checkNumber2 || checkNumber2===checkNumber3 || checkNumber1===checkNumber3)
