...
let highNumber = prompt('Сколько вам лет?','');
let lowNumber = prompt('Сколько вам лет?','');
let sumNumber = [];
let n = 0
...
for (lowNumber; lowNumber <= highNumber; lowNumber++) {
  n++
  sumNumber[n] = lowNumber
  console.log(sumNumber);
}
//  console.log(questiosumNumbernPoints)
alert(sumNumber.reduce(reducer));
