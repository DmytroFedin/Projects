...
if (currency.toUpperCase() === '3' || currency.toUpperCase() === 'EUR') {
  alert(converterSum * 0.87 + ' ' + 'Euro');
}
else if (currency.toUpperCase() === '1' || currency.toUpperCase() === 'UAH') {
  alert(converterSum * 26.3 + ' ' + 'UAH');
}
else if (currency.toUpperCase() === '2' || currency.toUpperCase() === 'AZN') {
  alert(converterSum * 1.70 + ' ' + 'AZN');
}
else if ((currency == null || currency == '') && (converterSum == null || converterSum == '')){
