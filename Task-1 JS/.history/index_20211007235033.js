...
// let currency = prompt('choose currency beetween UAH, AZN and EUR','');
...
//   alert(sumEuro + ' ' + 'Euro');
// }
// else if (currency.toUpperCase() === 'UAH') {
...
//   discountSum = purchaseSum * 0.97;
//   Math.round(discountSum);
//   alert('Your sum after discount is:' + ' ' + discountSum);
// }
// else if (purchaseSum >= 300 && purchaseSum < 500) {
//   discountSum = purchaseSum * 0.95;
//   Math.round(discountSum);
//   alert('Your sum after discount is:' + ' ' + discountSum);
// }
// else if (purchaseSum >= 500) {
//   discountSum = purchaseSum * 0.93;
//   Math.round(discountSum);
//   alert('Your sum after discount is:' + ' ' + discountSum);
// }
...
let firstQuestion = prompt('Arthur is a good tutor?(Yes/No/Who is Arthur?)','');
let secondQuestion = prompt('How are u feeling about this course?(Good/Bad/Where am I?)','');
let thirdQuestion = prompt('Are u ready to be Джавастриптизер?(Yes/No/I am already)','');
