...
check.addEventListener('mouseover', () => {
  check.classList.toggle('hover-purple');
})
...
textResult.innerHTML = 'Товаров на : ' + bucketValue + ' грн';
